  ...
  <div class="app-container">
    ...
    >
      <el-form ref="roleForm" :model="roleForm" size="small" label-width="80px">
        ...
        <el-form-item label="分配角色">
          <el-select v-model="roleForm.roleId" placeholder="请选择角色" style="width: 380px">
    ...
    >
      ...
      <el-table-column label="操作" width="300px" align="center">
        <template slot-scope="scope">
          <el-popover v-if="scope.row.status === 'ACTIVE'" :ref="scope.row.id" placement="top" width="180">
            <p>确定激活该账号吗？</p>
            <div style="text-align: right; margin: 0">
              <el-button size="mini" type="text" @click="$refs[scope.row.id].doClose()">取消</el-button>
              <el-button :loading="toggleLoading" type="primary" size="mini" @click="handleToggle(scope.row)"
                >确定</el-button
              >
            </div>
